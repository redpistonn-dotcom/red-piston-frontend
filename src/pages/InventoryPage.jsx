...
export function InventoryPage({ products, movements, activeShopId, onAdd, onEdit, onSale, onPurchase, onAdjust, toast }) {
    ...
    return (
        <div className="page-in" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            {/* Toolbar */}
            <div className="page-header" style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
            ...
            {/* Category chips */}
            <div className="filter-bar" style={{ display: "flex", gap: 6, flexWrap: "wrap", alignItems: "center" }}>
                ...
                <table style={{ width: "100%", minWidth: 1020, borderCollapse: "collapse" }}>
                    ...
                    <tbody>
                        {filtered.slice(0, visibleCount).map(p => {
                            ...
                            return (
                                <Fragment key={p.id}>
                                    <tr className="row-hover" onClick={() => setExpandedId(expandedId === p.id ? null : p.id)} style={{
